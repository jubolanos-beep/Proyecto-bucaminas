...
int main (){
	...
	cout<<"BUSCAMINAS"<<endl<<"Escoja el nivel que desea jugar"<<endl<<"Oprima 1 para f·cil (8x8)"<<endl<<"Oprima 2 para medio (16x16)"<<endl<<"Oprima 3 para difÌcil (16x30)"<<endl<<"Oprima 4 para ver los mejores puntajes"<<endl;
	int nivel;
